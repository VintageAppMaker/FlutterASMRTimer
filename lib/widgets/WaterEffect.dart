...
class WaterEffect extends StatefulWidget {
  ...
  WaterEffect( {required this.backWidget, required this.frontWidget, required this.alpha, required this.colorIndx });
...
class _WaterEffectState extends State<WaterEffect> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: themeWaterColors[widget.colorIndx][0], //Color(0xff2B2C56),
      body: Stack(
        children: [
